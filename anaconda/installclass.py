...
from iw.ctl_checkbutton import getKvmAndCdmsFlags
...
class BaseInstallClass(object):
    ...
    def setGroupSelection(self, anaconda):
        ...
        grps = ('core', 'server-policy')
        '''
        (kvm, cdms) = getKvmAndCdmsFlags()

        if kvm == 1:
            #grps = grps + ('kvm_group',)
            os.system("touch /mnt/sysimage/kvm")

        if cdms == 1:
            #grps = grps + ('cdms_group',)
            os.system("touch /mnt/sysimage/cdms")
        '''
